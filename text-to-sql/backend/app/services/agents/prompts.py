...
ENGINEER_SYSTEM_PROMPT = (
    ...
    "Build first ICU stay with ROW_NUMBER, use a 24h window from ICUSTAYS.INTIME, and derive mortality from ADMISSIONS.HOSPITAL_EXPIRE_FLAG. "
...
ERROR_REPAIR_SYSTEM_PROMPT = (
    ...
    "For ICU first-24h lactate vs mortality repairs, use ICUSTAYS first-stay windowing + LABEVENTS/D_LABITEMS lactate filtering + ADMISSIONS.HOSPITAL_EXPIRE_FLAG outcome. "
