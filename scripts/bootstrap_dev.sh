...
main() {
  ...
  ensure_env_file "$ROOT_DIR/text-to-sql/.env" "$ROOT_DIR/text-to-sql/.env.example"
  ensure_env_file "$ROOT_DIR/query-visualization/.env" "$ROOT_DIR/query-visualization/.env.example"
  ensure_env_file "$ROOT_DIR/.env" "$ROOT_DIR/.env.example"

  install_python_requirements "$ROOT_DIR/query-visualization" "requirements.txt"
  install_python_requirements "$ROOT_DIR/text-to-sql/backend" "requirements.txt"
  install_ui_deps
